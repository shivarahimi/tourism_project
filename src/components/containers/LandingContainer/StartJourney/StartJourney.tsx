...
const StartJourney: FC<ISharePropType> = ({ dataType }) => {
  ...
  return (
    // به والد و متن زدایندکس10دادم و به عکس منفی تا عکس زیر متن واقع شود
    <section className="relative z-20 bg-[url('/images/landing/StartJourney/wc-bg2.png')] bg-cover bg-center bg-no-repeat py-40">
      ...
      <FullImage
        ...
        width={550}
        height={550}
        className="hidden lg:block !-z-10 xl:!z-20 absolute top-20 left-[17rem] mobile-negative-z"
        // style={{ zIndex: -1 }}
      />
      <FullImage
        src={defaultImage3}
        ...
        width={600}
        height={600}
        className="hidden lg:block absolute -bottom-20 right-60"
      />
